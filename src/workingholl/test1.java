...
import org.openqa.selenium.interactions.Actions;
	...
	/*		driver.get("http://kompass-iec-eic.international.gc.ca/registration-inscription?regionCode=DE");
			...
			WebElement text1=driver.findElement(By.xpath("//*[@id=\"form1\"]/div[3]/h1"));
			for(int k=0;;k++){
...
//Secret_Question_1
			...
			for(int k=0;;k++){
				try{
					Thread.sleep(1000);
					WebElement cheking3=driver.findElement(By.partialLinkText("Kompass account – Validation Email Successfully Sent"));
					String cheking3ok=cheking3.getText();
					if(cheking3ok.equals("Kompass account – Validation Email Successfully Sent")){
						System.out.println("3페이지 대기 중");
						break;
					}else{
						try{
							Thread.sleep(1000);
